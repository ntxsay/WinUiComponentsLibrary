...
namespace WinUiComponentsLibrary.Code.Extensions
{
    ...
    {
        public static bool ScrollToElement(this ScrollViewer scrollViewer, UIElement element, bool isVerticalScrolling = true, bool smoothScrolling = true, float? zoomFactor = null)
        {
